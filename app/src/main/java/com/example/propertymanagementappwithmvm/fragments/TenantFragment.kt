...
import com.example.propertymanagementappwithmvm.databinding.FragmentTenantBinding
 ...
 * [TenantFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [TenantFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TenantFragment : Fragment(), RegisterViewModel.RegisterViewModelInterface {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var listener: OnFragmentInteractionListener? = null

    lateinit var tenantFragmentBinding : FragmentTenantBinding
    ...
    override fun onCreateView(
        ...
        tenantFragmentBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_tenant, container, false)
        var view : View =  tenantFragmentBinding.root
        ...
        tenantFragmentBinding.registerViewModel = registerViewModel

        //set this fragment as a listener to the register view model
        registerViewModel.setupListener(this)
        registerViewModel.account = Config.TENANT_ACCOUNT
